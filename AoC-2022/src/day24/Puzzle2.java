...
//        }
        ...
        stepsCount[0]++;
        var endState = new State(stepsCount[0], end);
        blizzardPositions.clear();
        for (var b : blizzards)
        {
            b.move(dimensions);
        ...
        result = ImplicitGraph.BFSSteppedCond(
            endState, 
            (next) ->
            {
                return next.position.equals(startf);
            },
            (node) ->
            {
                return 
        ...
        path = result.getPath(new State(stepsCount[0]+1, end));
        for (var p : path)
        {
            System.out.println(p);
        }
        ...
        stepsCount[0]++;
        startState = new State(stepsCount[0], start);
        blizzardPositions.clear();
        for (var b : blizzards)
        {
            b.move(dimensions);
        ...
        System.out.println(path.size()-1);
        System.out.println(stepsCount[0]+1);
