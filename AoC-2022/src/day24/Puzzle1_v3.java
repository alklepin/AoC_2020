...
public class Puzzle1_v3 extends PuzzleCommon
{

    public static void main(String [] args)
        throws Exception
    {
        new Puzzle1_v3().solve();
    }
...
//        var inputFile = "input1_test2.txt";
        ...
        HashSet<IntPair> blizzardPositions1 = new HashSet<>();
        HashSet<IntPair> blizzardPositions2 = new HashSet<>();
//        for (var b : blizzards)
//        {
...
//        }
        ...
        blizzardPositions1.clear();
        blizzardPositions2.clear();
        for (var b : blizzards)
        {
            blizzardPositions1.add(b.position);
            b.move(dimensions);
            blizzardPositions2.add(b.position);
        }
        ...
        var result = ImplicitGraph.BFSSteppedCond(
            ...
            (node) ->
            {
                return 
                    ...
                    .where(
                        n -> {
                            return interior.getAtXY(n) == '.' 
                               // && !blizzardPositions1.contains(n)
                                && !blizzardPositions2.contains(n)
                                ;
                        })
                    .select(n -> 
                    {
