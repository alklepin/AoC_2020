...
//        printMoves(movesB);
        ...
        HashMap<IntPair, String> movesA1 = new HashMap<>();
...
//            System.out.println("   "+best);
            movesA1.put(key, best);
        }
        
        HashMap<IntPair, String> movesA2 = new HashMap<>();
        ...
        for (String line : lines)
        {
            ...
            {
                var code = movesA2.get(IntPair.of(s.charAt(idx-1), s.charAt(idx)));
                res.append(code);
            }
