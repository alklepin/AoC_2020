...
//        var bound = 26501365;
        ...
        var targets = Query.wrap(Pair.of(0, bbound), Pair.of(1, bbound-1), Pair.of(bbound, 0), Pair.of(bbound-1, -1),
            Pair.of(0, -bbound), Pair.of(-1, bbound-1), Pair.of(-bbound, 0), Pair.of(-bbound+1, 1));
