...
//        LinesGroup lines = readAllLinesNonEmpty("input4.txt");
        ...
        for (var d : data)
        {
            ...
            if (d.getValue2())
            {
                ...
                {
                    var parts = d.getValue1().union(activeCubes);
                    for (var p : parts)
                    {
...
//                    {
//                        var parts = c.union(d.getValue1());
//                        for (var p : parts)
//                        {
//                            activeCubesNext.add(p);
//                        }
//                        for (var p1 : activeCubesNext)
//                        {
//                            for (var p2 : activeCubesNext)
//                            {
//                                if (!p1.equals(p2) && p1.intersect(p2) != null)
//                                {
//                                    System.out.println("Has intersection! " + p1 + " " +p2);
//                                }
//                            }
//                        }
//                    }
